...
{
	/// <summary>
	/// Summary description for SectorAnalysis.
	/// </summary>
	public class SectorAnalysis : System.Windows.Forms.Form
	{
		...
		private void btnRefreshSAViewPort_Click(object sender, System.EventArgs e)
		{
			...
			for (int X1=63; X1>=0; X1--)
			{
				...
				{
					byte[] tile = (byte[])Helper.SectorTiles[Y1*64+X1];
		...
		private void SectorAnalysis_Load(object sender, System.EventArgs e)
		{
		...
		private void SectorAnalysis_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			//btnRefreshSAViewPort_Click(sender, e);
		}

		private void SectorAnalysis_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			SysMsg.SM_SAN_ENABLED = false;
		}

		private void btnQuick1_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnQuick2_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnQuick3_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnQuick4_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnQuick5_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnQuick6_Click(object sender, System.EventArgs e)
		{
            SVB1_STATE = false;
            SVB2_STATE = false;
            SVB3_STATE = false;
		...
		private void btnTotalRefreshSA_Click(object sender, System.EventArgs e)
		{
			Graphics ptr_vp = viewport.CreateGraphics();
