...
namespace ToEE_World_Builder
{
    ...
    public class Helper
    {
        ...
        // v1.7.5s1: For Cerulean the Blue: a string of last opened MOB file
        public static string LastOpenedMOB = "";
        ...
        {
            // NOTE: This function might have become deprecated since v1.7.x
        ...
        // Keep in mind that the count starts from 1 in MOB_SetProperty, NOT from 0
        ...
        // a 64-bit version of the function above
        ...
        {
            string sectorNameX = int.Parse(sectorName).ToString("X").PadLeft(8, '0');
        ...
        // NOTE: in fact, minX and minY are reversed here... as well as
        // maxX and maxY... sorry
        ...
        // Sector data
        public static ArrayList SectorTiles = new ArrayList();
        ...
        public static void SEC_SetTileData(int X, int Y, byte[] tiledata)
        {
            ...
            // FIXME: Tile position in an array of tiles?
            int target = Y * 64 + X;
        ...
        // VERIFY: Double-check how well this works!
        public static bool SEC_SetTileDataRange(int minX, int maxX, int minY, int maxY, byte[] tiledata)
        {
        ...
        // Light structures for the Extended Sector Light Editor
        ...
        // Light flags
        public uint LGT_STATUS_1 = 0x00000001;
